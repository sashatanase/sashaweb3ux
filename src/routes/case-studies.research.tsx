...
export const Route = createFileRoute("/case-studies/research")({
  head: () => ({
    meta: [
      { title: "Research Case Studies · Sasha (Tanase) Luca" },
      {
        name: "description",
        content:
          "Selected UX research case studies — diary studies, usability testing, and generative interviews across Web3.",
      },
      { property: "og:title", content: "Research Case Studies · Sasha (Tanase) Luca" },
      {
                ...
                <div className="grid grid-cols-12 gap-8">
                  <div className="col-span-12 min-w-0 md:col-span-8">
                    ...
                    <h2 className="mt-6 text-lg font-medium leading-[1.2] tracking-tight break-words sm:text-3xl md:text-4xl lg:text-5xl">
                      <Link to={cs.href} className="transition-colors hover:text-accent">
                        {cs.title}
                      </Link>
                    </h2>
