    ...
    >
      ...
      <DesignSection number="03" title="Solution">
        ...
        <p>
          ...
          could draw on at any time.
        </p>

        <p>
          That turned the frightening part, exposing real money to something that could take it,
          into a position a person could read and adjust with their eyes open, which for an
          interface handling money is the difference between trust and a leap of faith.
        </p>
