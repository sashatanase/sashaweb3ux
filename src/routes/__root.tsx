...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sasha Luca" },
      { name: "description", content: "Personal portfolio of Sasha Luca — selected work, writing, and contact." },
      { property: "og:title", content: "Sasha Luca" },
      { property: "og:description", content: "Personal portfolio of Sasha Luca — selected work, writing, and contact." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Sasha Luca" },
      { name: "twitter:description", content: "Personal portfolio of Sasha Luca — selected work, writing, and contact." },
