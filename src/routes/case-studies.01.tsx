    ...
    >
      ...
      <CaseStudySection number="02" title="The Approach: Capturing Friction in the Wild">
        ...
        <p>
          ...
          configuration, and prior protocol node setup experience.
        </p>
      ...
      <CaseStudySection number="03" title="The Plot Twists: Assumptions vs. Reality">
        <p>
          ...
          different from what the team had anticipated. The study uncovered three massive strategic
          pivots.
        </p>
        ...
        <p>
          ...
          leaving broken nodes unattended.
        </p>
      ...
      <CaseStudySection number="04" title="The Impact: Rewriting the Developer Experience">
        ...
        <ul className="ml-5 list-disc space-y-4 marker:text-muted-foreground">
          <li>
            <strong className="font-semibold">Product Architecture:</strong> We split the staking UI
          ...
          <li>
            <strong className="font-semibold">Documentation Strategy:</strong> We introduced
            mandatory "Monitoring & Troubleshooting" sections. This explicitly detailed why
            high-resource specs were required, successfully preventing the node downgrade behavior.
          </li>
          <li>
            <strong className="font-semibold">Developer Experience (DX):</strong> We completely
            re-engineered the client logging hierarchy, injecting explicit severity grades and
            verbose error messaging to differentiate between user-level and network-level failures.
          </li>
        </ul>
        <div className="mt-12">
          <a
