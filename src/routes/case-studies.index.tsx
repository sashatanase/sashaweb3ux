...
function CaseStudiesHub() {
  return (
    <CaseStudiesShell>
      ...
      <section className="grid grid-cols-1 gap-0 py-16 md:grid-cols-2 md:py-24">
        {SECTIONS.map((s, i) => (
          <Link
            key={s.no}
            to={s.href}
            className={`group relative flex min-h-[360px] flex-col justify-between border-border p-8 transition-colors hover:bg-foreground/[0.02] md:min-h-[520px] md:p-12 ${
              i === 0
