    ...
    >
      ...
      <DesignSection number="05" title="The Solution - Iteration 3 · what shipped">
        ...
        <figure className="relative left-1/2 w-screen -translate-x-1/2 py-4">
          <div className="relative h-screen w-full overflow-hidden border-y border-border md:border-x-0">
            <iframe
              src="https://embed.figma.com/proto/X9u1z67oBm7WuoZkHj112Y/tBTC-Final---prototype?page-id=0%3A1&node-id=1-8479&scaling=scale-down-width&content-scaling=responsive&starting-point-node-id=1%3A8479&hide-ui=1&embed-host=share"
